...
let evenNumbers = mixedNumbers.filter(ans => ans%2==0)
...
//Code Here
let myStrongest = monstersInYourPocket.filter(vals => vals.CP>=200);
...
let orderTotals = orders.map( sum => sum.price * (sum.tax +1));
